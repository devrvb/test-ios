 ...
 *
 * @param[in] nPort				通道号
 * @param[in] startType			开启类型， 0只开启鱼眼校正, 1同时开启联动和校正, 2只开启鱼球联动算法, 3表示180度鱼眼矫正
 * @param[in] funcType			开启哪些功能，0表示都不开启，1表示只开启智能帧功能，2表示只开启抓图，3表示智能帧和抓图都开启，开启的功能越多，消耗的内存越大								
